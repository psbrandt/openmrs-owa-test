...
This repository contains the asd OpenMRS Open Web App.
...
This will create a file called `asd.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/psbrandt/workspace/refapp-standalone-2.6.0/appdata/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/psbrandt/workspace/refapp-standalone-2.6.0/appdata/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/psbrandt/workspace/refapp-standalone-2.6.0/appdata/owa",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/asd/index.html"
}
```
